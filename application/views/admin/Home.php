...
<body>
	...
	<nav>
		...
		<div class="topbar">
			<div class="searchbut">
				<input type="text" class="form-control border-0 shadow-none bc-black" style="color:grey;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;letter-spacing: 1px;" placeholder="Search..."
					aria-label="Search..." />
			</div>
